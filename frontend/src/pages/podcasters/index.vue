...
import {
  podcastersWithPodcastsQuery,
  type PodcastersWithPodcastsQuery,
  ...
  <div class="grid grid-cols-3 gap-4">
    <Card v-for="podcaster in podcasters">
      ...
      <CardContent>
        has posted
        <b>{{
          podcaster.podcasts[0] ? podcaster.podcasts[0].name : 'nothing yet'
        }}</b></CardContent
      >
      <CardFooter>
        <Button>
          <RouterLink
            :to="{ name: '/podcasters/[id]', params: { id: podcaster.id } }"
